import { Button, Divider, Drawer, Flex, Input, Popconfirm, Table, Tooltip, Checkbox, TimePicker, Space, Form, Modal, Card, Grid, Skeleton } from 'antd';
import Title from 'antd/es/typography/Title';
import { AddIcon, CalendarIcon, DeleteIcon, EditIcon } from '@/app/components/Icon';
            ...
            {schedule.map((item) => (
              ...
              >
                <Checkbox
                  ...
                  onChange={(e) => handleCheckboxChange(item.day, e.target.checked, item.schedule_id)}
                >
                  {item.day}
                </Checkbox>
                  ...
                  <div style={{ marginTop: 16 }}>
                    {item.times.map((time, index) => (
                      ...
                      >
                        ...
                        >
                          <TimePicker
                            value={time.start ? dayjs(time.start, 'HH:mm') : null}
                            onChange={(value) => handleTimeChange(item.day, index, 'start', value)}
                            format='HH:mm'
                        ...
                        >
                          <TimePicker
                            ...
                            onChange={(value) => handleTimeChange(item.day, index, 'end', value)}
                            format='HH:mm'
                        ...
                        <Button
                          type='text'
                          danger
                          onClick={() => removeTimeSlot(item.day, index, item.schedule_id)}
