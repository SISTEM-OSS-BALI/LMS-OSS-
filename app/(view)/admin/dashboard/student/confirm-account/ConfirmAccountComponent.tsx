...
import { Tag, Image, Button, Skeleton, Card, Space, Modal, Form, Input, Select, Grid, Flex } from 'antd';
import dayjs from 'dayjs';
import Title from 'antd/es/typography/Title';

export default function ConfirmAccountComponent() {
  const { confirmAccount, isLoadingConfirmAccount, loadingId, handleApprove, isModalDataVisible, handleCloseModal, handleOpenModal, form, consultantData, handleFinish, loading } = useConfirmAccountViewModel();
  ...
  const columns: ColumnsType<TermsAgreement> = [
    ...
    },
    {
      ...
      dataIndex: 'is_agreed',
      key: 'is_agreed',
      render: (text: boolean) => (text ? <Tag color='green'>Sudah</Tag> : <Tag color='red'>Belum</Tag>),
    },
    {
      title: 'Tanggal',
      dataIndex: 'agreed_at',
      ...
      {isLoadingConfirmAccount ? (
        ...
        >
          <Table
            ...
            scroll={{ x: 'max-content' }} // Agar tabel bisa di-scroll di mobile
          />
        </Card>
      )}
