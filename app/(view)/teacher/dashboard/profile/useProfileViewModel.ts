...
export const useProfileViewModel = () => {
  ...
  const mergedData: User & { program?: Program } = {
    ...
    name_group: profileData?.data?.name_group ?? null, // ✅ Diperlukan
    type_student: profileData?.data?.type_student ?? "INDIVIDUAL",
    ...
    renew_program: profileData?.data?.renew_program ?? null,
    renew_date: profileData?.data?.renew_date ?? null,
